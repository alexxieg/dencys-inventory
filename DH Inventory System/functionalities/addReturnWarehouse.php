<?php
	if (isset($_POST["addRet"])){
		...
		$sql = "INSERT INTO returns (returnDate, returnQty, returnType, returnRemark, prodID, receiptNo ,branchID)
				VALUES (CURDATE(),'".$_POST['retQty']."','Warehouse Return','".$_POST['retRemarks']."','$prod3','$recNo','$branch3')";
		$conn->exec($sql);
